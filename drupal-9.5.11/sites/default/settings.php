 ...
 * @endcode
 */
$settings['hash_salt'] = 'RANDOM_STRING_HERE';
$databases['default']['default'] = [
  'database' => 'drupaldb',   // Replace with your actual DB name
  'username' => 'root',                 // Your DB username
  'password' => '',                     // Your DB password
  'host' => '127.0.0.1',                // Use 127.0.0.1 for TCP connection
  'port' => 3307,                    // Your MySQL port (change if needed)
  'driver' => 'mysql',
  'prefix' => '',
  'collation' => 'utf8mb4_general_ci',
];
 ...
 * @endcode
 */
$settings['hash_salt'] = 'aDJXeCJuw-AWeXFWJuZbaZYxt0U4YpYtLETyU_mxctGXBf_ERhU-r_fpFnU2voAc0syPWBDRdQ';
...
// );
$settings['config_sync_directory'] = 'sites/default/files/config_InIlUe9h0HuU4zINJ92gHq08_WJRn3ZWSnGT4U7aQewHf5XLzyYkZKhoNiXOQAnde0wDgHW3Gw/sync';
